...
(function($) {
	...
	me.DefaultLoadingScreen = me.ScreenObject.extend({
		...
		draw : function(context) {
			...
			// measure the logo size
			var logo1_width = this.logo1.measureText(context, "Drei").width;
			var xpos = (me.video.getWidth() - logo1_width - this.logo2.measureText(context, "Game").width) / 2;
			...
			this.logo1.draw(context, 'Drei', xpos , ypos);
			xpos += logo1_width;
			this.logo2.draw(context, 'Game', xpos, ypos);
			
			ypos += this.logo1.measureText(context, "Drei").height / 2;
